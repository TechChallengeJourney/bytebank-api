...
export const financialStatusWidget = async (userId: string) => {
    ...
    return {
        ...
        description: isPositive
            ? 'Parabéns! Sua situação financeira está positiva, com receitas superiores às despesas e um bom saldo. Isso mostra que você está no caminho certo para manter a saúde financeira. Continue investindo em boas práticas de gerenciamento e planejamento. Ótimo trabalho!'
